...
class ValData(data.Dataset):
    ...
    def get_images(self, index):
        ...
        haze_img = Image.open(self.val_data_dir + 'rain/' + haze_name)

        try:
            gt_img = Image.open(self.val_data_dir + 'norain/' + gt_name + '.jpg').convert('RGB')
            # print(gt_img.shape)
        except:
            gt_img = Image.open(self.val_data_dir + 'norain/' + gt_name + '.png').convert('RGB')
