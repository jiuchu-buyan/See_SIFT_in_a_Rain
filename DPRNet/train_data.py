...
class TrainData(data.Dataset):
    def __init__(self, crop_size, train_data_dir, train_filename):
        ...
        with open(train_list) as f:
            ...
            gt_names = [i.split('.')[0] for i in haze_names]
    ...
    def get_images(self, index):
        ...
        haze_img = Image.open(self.train_data_dir + 'rain/' + haze_name)

        try:
            gt_img = Image.open(self.train_data_dir + 'norain/' + gt_name + '.jpg').convert('RGB')
            # print(gt_img.shape)
        except:
            gt_img = Image.open(self.train_data_dir + 'norain/' + gt_name + '.png').convert('RGB')
